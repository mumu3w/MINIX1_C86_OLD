...
EXTRN color:WORD, cur_proc:WORD, proc_ptr:WORD,	splimit:WORD, vid_mask:WORD
PUBLIC vec_tabl
...
vid5:   popf			; restore flags
	...
	mov 10[bp],bx		; set up residual count
        push bx                 ;
        mov bx,0                ;
	mov 8[bp],bx            ; start copying at base of video ram
	cmp 4[bp],bx            ; NIL_PTR means store blanks
        pop bx                  ;
	je vid0			; go do it
